...
def setup_parser():
    ...
    ########################Pretrained Model#########################
    parser.add_argument('--pseudo_path', type=str, default='pseudo_labels/n01443537/n01443537_2.png',
                        help='path to pseudo_label')
    parser.add_argument('--sam_path', type=str, default='sam/n01443537/n01443537_2',
                        help='path to sam')
