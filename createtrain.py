...
target_path = os.path.abspath('./weights/pass50/pixel_classification/train_42865_0.866_ccy')
for f in os.listdir(source_path):
    target_dir = os.path.join(target_path, f)

    if not os.path.exists(target_dir):
        os.makedirs(target_dir)
img_label1= load_annotations_1('./weights/pass50/pixel_classification/train_42865_0.866_ccy.txt')
D_1 = list(img_label1.values())

root='/home/litingting/jittor/ImageNetS50/train'
root2='./weights/pass50/pixel_classification/train_42865_0.866_ccy'
count=0
