...
def getOption():
    ...
    parser.add_argument("--pseudo_path_first", type=str, default=None, help="The path to pseudo dataset.")
    parser.add_argument("--pseudo_path_second", type=str, default=None, help="The path to pseudo dataset.")
    #########################
    #### other parameters ###
    #########################
    ...
    parser.add_argument("--dump_path_1", type=str, default=".",
                        help="experiment dump path for checkpoints and log")
    parser.add_argument("--testPoint_path", type=str, default=".",
                        help="experiment dump path for checkpoints and log")
    parser.add_argument("--testLabel_path", type=str, default=".",
                        help="experiment dump path for checkpoints and log")
