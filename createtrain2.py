...
target_path = os.path.abspath('./weights/pass50/pixel_classification/train_clean_ccy_e36')
for f in os.listdir(source_path):
    target_dir = os.path.join(target_path, f)

    if not os.path.exists(target_dir):
        os.makedirs(target_dir)
img_label1= load_annotations_1('./weights/pass50/pixel_classification/clean_ccy_e36.txt')
D_1 = list(img_label1.values())

root='/home/litingting/jittor/ImageNetS50/train'
root2='./weights/pass50/pixel_classification/train_clean_ccy_e36'
count=0
