...
parser.add_argument("-a", "--arch", default="resnet18", type=str, help="convnet architecture")
...
def main():
    ...
    val_folder = '/farm/litingting/jittor/resnet_fcn/scripts/weights/pass50/pixel_finetuning_opt/validation_crf_sam_2_mask/'
