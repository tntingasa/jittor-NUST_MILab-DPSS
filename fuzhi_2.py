...
# #第3步   按分类去噪后的标签更改像素值t
img_label = load_annotations('./weights/pass50/pixel_finetuning_2/train_labeled_53.07.txt')
root_t = './weights/pass50/pixel_finetuning_1/sam-train-3/train_1'
...
for i in range (len(image_name)):
        ...
        if not os.path.exists(target_img) or label[i]==-2:
            mask_path = './weights/pass50/pixel_finetuning_1/train'
